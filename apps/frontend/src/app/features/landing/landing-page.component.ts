    ...
    <div class="landing">
      ...
      <header class="landing__header">
        <div class="landing__header-content">
          ...
          <nav class="landing__nav">
            <a routerLink="/auth/login" mat-button class="landing__nav-link"> Zaloguj się </a>
            <a
      ...
      <section class="landing__hero">
        <div class="landing__hero-content">
          <h1 class="landing__hero-title">Proste fakturowanie<br />dla freelancerów</h1>
          <p class="landing__hero-subtitle">
            Wystawiaj profesjonalne faktury VAT w kilka sekund. Bez zbędnych funkcji, bez
            komplikacji.
          </p>
  ...
  readonly features: Feature[] = [
    {
      ...
      description:
        'Wystaw fakturę w mniej niż minutę. Intuicyjny formularz z autouzupełnianiem danych kontrahentów.',
    },
    {
      icon: 'picture_as_pdf',
      title: 'Eksport do PDF',
      description:
        'Generuj profesjonalne faktury PDF jednym kliknięciem. Gotowe do wysłania lub wydruku.',
    },
    {
      icon: 'people',
      title: 'Baza kontrahentów',
      description:
        'Zapisuj dane kontrahentów i używaj ich przy kolejnych fakturach. Zero przepisywania.',
    },
    {
      icon: 'shield',
